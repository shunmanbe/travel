...
Route::group(['middleware'=>['auth']], function(){ 
    ...
    // グループ
    #グループ一覧を表示
    Route::get('itineraries/group/index', 'GroupController@show_group')->name('index.group');
    #グループを作成
    Route::get('/itineraries/create/group', 'GroupController@create_group')->name('create.group');
    #グループを保存
    Route::post('itineraries/create/group', 'GroupController@store_group')->name('store.group');
    #グループのしおり一覧へ
    Route::get('/itineraries/group/{group}/itinerary_index', 'GroupController@itinerary_index')->name('group.itinerary_index');
    
    // しおり作成
    #新規登録画面へ
    Route::get('/itineraries/group/{group}/new_entry', 'GroupController@new_entry')->name('group.new_entry');
