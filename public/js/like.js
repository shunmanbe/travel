...
/* WEBPACK VAR INJECTION */(function($) {$(function () {
  ...
  var likeItineraryId; //変数を宣言

  like.on('click', function () {
    //.onはイベントハンドラー。第一パラメータにイベントの種類、第二パラメータにハンドラとして無名関数。
    var $this = $(this); //this=イベントの実行した要素＝iタグを代入
...
module.exports = __webpack_require__(/*! /home/ec2-user/environment/travel/resources/js/like.js */"./resources/js/like.js");
